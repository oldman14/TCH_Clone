...
const OrderStack = ()=>{
    return(
        ...
        >
        <Stack.Screen options={{headerTransparent: true}} name='Order' component={Order}/>
        </Stack.Navigator>
    )
}
const StoreStack = ()=>{
    ...
    return (
        ...
        barStyle={{ backgroundColor: '#fff' }}
         >
            ...
            />
            <Tab.Screen name='StoreStack' component={StoreStack}
            options={{
                title: 'Cửa hàng',
                tabBarIcon: ({focused}) => (
                  <MaterialCommunityIcons
            ...
            />
            <Tab.Screen name='PointStack' component={PointsStack}
            options={{
                title: 'Tích điểm',
                tabBarIcon: ({focused}) => (
                  <MaterialCommunityIcons
